...
report assets under `docs/generated/reports/<trail>/` (`storyboard.webp`, `timeline.webp`,
...
# Trail slugs that have a gallery section. Each maps to docs/generated/reports/<slug>/.
TRAILS = ["wikipedia"]
...
def on_pre_build(config):
    ...
    for trail in TRAILS:
        trail_dir = docs_dir / "generated" / "reports" / trail
